                        ...
                        <form class="form-horizontal" action="srvUsuario?accion=registrar" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nombre Para Marca</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: TecnicMotoCycles" name="txtNombre" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: TecnicMotoCycles" name="txtEstado" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                            </div>

...
<html>
    <head>
        ...
        <title>Sistema TMC| nv/Empleado</title>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="txtNOMBREEmpl" type="text" class="form-control" placeholder="Ejem: JhonFy" name="txtNOMBREEmpl" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtAPELLIDOSEmpl" type="text" class="form-control" placeholder="Ejem: Pelayo" name="txtAPELLIDOSEmpl" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtSEXOEmpl" type="text" class="form-control" placeholder="Ejem: H/M" name="txtSEXOEmpl" maxlength="1"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtTELEFONOEmpl" type="text" class="form-control" placeholder="Ejem: 3123456789" name="txtTELEFONOEmpl" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input type="date" id="fecha" onclick="" class="mt-4 form-control" name="txtFECHANACIMIENTOEmpl" value="">
                                    </div>
                                </div> 
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtTIPODOCUMENTOEmpl" type="text" class="form-control" placeholder="Ejem: CC/CE/PS" name="txtTIPODOCUMENTOEmpl" maxlength="20"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nùmero Documento</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtNUMERODOCUMENTOEmpl" type="text" class="form-control" placeholder="Ejem: ######" name="txtNUMERODOCUMENTOEmpl" maxlength="20"
                                               value="">
                                    </div>
                                </div>
                                <div>
                                    <input readonly id="nombre"  type="hidden"  class="form-control" placeholder="Ejem: Bogota D.C" name="txtIDUSUARIOEmpl" maxlength="1"
                                           value="1">
                                </div>
                            </div>

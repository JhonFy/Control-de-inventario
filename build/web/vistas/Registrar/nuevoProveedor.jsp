...
<html>
    <head>
        ...
        <title>Sistema TMC| nv/Proveedor</title>
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nuevo Proveedor</h3>  
                        </div>
                        <form class="form-horizontal" action="srvUsuario?accion=registrarProveedor" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nombre</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtPrvNombre" type="text" class="form-control" placeholder="Ejem: MotosDelCamino" name="txtPrvNombre" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Direcciòn</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtPrvDireccion" type="text" class="form-control" placeholder="Ejem: Av Crr 80 # 42 G 20 SUR" name="txtPrvDireccion" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nùmero Telefono</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtPrvTelefono" type="text" class="form-control" placeholder="Ejem: 3105447722" name="txtPrvTelefono" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nùmero Nit</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="txtPrvNit" type="text" class="form-control" placeholder="Ejem: 900503045-2" name="txtPrvNit" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                                <div>
                                    <input readonly  id="nombre"  type="hidden" class="form-control" placeholder="Ejem: Código Bogotá" name="txtPrvEstado" maxlength="20"
                                            value="1">
                                </div>
                            </div>

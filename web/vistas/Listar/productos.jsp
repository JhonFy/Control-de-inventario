        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <a href="srvUsuario?accion=nuevoProducto" class="btn btn-success">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaProductos" class="display">
                                    ...
                                    <c:forEach var="tmcProductos" items="${aProductos}" varStatus="itProductos"> 
                                        <tr> 
                                            <td align="left">${tmcProductos.nombreProducto}</td>
                                            <td align="left">${tmcProductos.marca.nombreMarca}</td>
                                            <td align="left">${tmcProductos.precio}</td>
                                            <td align="left">${tmcProductos.cantidad}</td>
                                            <td align="left">${tmcProductos.categoria.nombreCategoria}</td>
                                            <td>${tmcProductos.descripcion}</td>
                                            <td align="left">${tmcProductos.proveedores.nombre}</td>
                                        <input type="hidden" id="actPrd" value="${tmcProductos.idProducto}">
                                        <td align="center"><a id="actProductos" href="<c:url value="srvUsuario">
                                                                  <c:param name="accion" value="leerProducto" />
                                                                  <c:param name="cActualizarPrd" value="${tmcProductos.idProducto}" />
                                                              </c:url>"><button type="button" class="btn btn-warning" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                    <i class="fa fa-pencil"></i></button></a>

                                            <input type="hidden" id="codigoProductos" value="${tmcProductos.idProducto}">
                                            <a id="dltProductos" href="<c:url value="srvUsuario">
                                                   <c:param name="accion" value="eliminarProducto" />
                                                   <c:param name="cProducto" value="${tmcProductos.idProducto}" />

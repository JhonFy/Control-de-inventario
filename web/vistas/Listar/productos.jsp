                            ...
                            <div class="table-responsive">                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaProductos" class="display">
                                    ...
                                    <c:forEach var="tmcProductos" items="${aProductos}" varStatus="itProductos"> 
                                        <tr> 
                                            <td align="center">${itProductos.index + 1}</td>
                                            <td>${tmcProductos.nombreProducto}</td>
                                            <td align="center">${tmcProductos.marca.nombreMarca}</td>
                                            <td align="center">${tmcProductos.precio}</td>
                                            <td align="center">${tmcProductos.cantidad}</td>
                                            <td align="center">${tmcProductos.categoria.nombreCategoria}</td>
                                            <td>${tmcProductos.descripcion}</td>
                                            <td align="center">${tmcProductos.proveedores.nombre}</td>

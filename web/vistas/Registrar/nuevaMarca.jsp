...
<html>    
    <head>
        ...
        <title>Sistema TMC| nv/Marca</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-md-5 ">
                            <div class="btn-group pull-right">
                                <a href="srvUsuario?accion=listarMarca" class="btn btn-danger">
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nueva Marca</h3>  
                        </div>
                        <form class="form-horizontal" action="srvUsuario?accion=registrarMarca" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Nombre Marca</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-database"></i></span>
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: AKT" name="txtNombreMarca" maxlength="30"
                                               value="">
                                    </div>
                                </div>
                                <div>
                                    <input readonly  id="Estado"  type="hidden" class="form-control" placeholder="Ejem: Código Bogotá 1" name="txtEstadoMarca" maxlength="20"
                                           value="1">
                                </div>
                            </div>
                            <div class="box-footer">
                                <button type="submit" id="" name="btnRegistrarMarca" value="Registrar" class="btn btn-success"><i class="fa fa-floppy-o"></i> Registrar</button>
                            </div>
                        </form>
                    </div>
                </section> 

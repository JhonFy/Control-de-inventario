                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="srvUsuario?accion=listarCargo"><i class="fa fa-folder-open-o"></i>Cargo</a></li>
                                <li><a href="srvUsuario?accion=listarCategorias"><i class="fa fa-cube"></i>Categorias</a></li>
